...
city_names.forEach(function(e) {
    var city = '<li class="form__dropdown-item city-item">' + e + '</li>';
    citiesList.insertAdjacentHTML('beforeend', city);
});


document.querySelectorAll('.city-item').forEach(function(e) {
...
document.querySelectorAll('.form__wrapper').forEach(function(e) {
